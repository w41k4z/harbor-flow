...
<% 
    ...
    BoatFlag[] allBoatFlags = (BoatFlag[]) request.getAttribute("allBoatFlags");
                                        ...
                                        <div class="text-black">
                                            <div class="card">
                                                ...
                                                <div class="card form-content">
                                                    <form action="<%= request.getContextPath() %>/boats/new"
                                                        ...
                                                        <div class="col-auto col-lg-12">
                                                            <label class="form-label" for="towing">Towing time</label>
                                                            <input type="number" name="towing" id="towing" class="form-control" required />
                                                        </div>
                                                        <div class="col-auto col-lg-12">
                                                            <label class="form-label" for="boat_categ">Category</label>
                                                            <select name="type" id="boat_categ" class="form-select" required>
                                                                <% for(int i = 0; allBoatCategories != null && i < allBoatCategories.length; i++) { %>
                                                                    <option value="<%= allBoatCategories[i].getBoatCategoryID() %>">
                                                        ...
                                                        <div class="col-auto col-lg-12">
                                                            <label class="form-label" for="flag_id">Flag</label>
                                                            <select name="flag" id="flag_id" class="form-select" required>
                                                                <% for(int i = 0; allBoatFlags != null && i < allBoatFlags.length; i++) { %>
                                                                    <option value="<%= allBoatFlags[i].getBoatFlagID() %>">
                                                                        <%= allBoatFlags[i].getOrigin() %>
                                                                    </option>
                                                                <% } %>
                                                            </select>
                                                        </div>
                        ...
                        <tbody>
                            <% for (int i = 0; allBoats != null && i < allBoats.length; i++) { %>
                                <tr>
                                    ...
                                    <td><%= allBoats[i].getName() %></td>
                                    <td><%= allBoats[i].getType() %></td>
                                    <td><%= allBoats[i].getLength() %></td>
                                    <td><%= allBoats[i].getWidth() %></td>
                                    <td><%= allBoats[i].getDepth() %></td>
                                    <td><%= allBoats[i].getWeight() %></td>
                                    <td><%= allBoats[i].getTowing() %></td>
                                    <td><%= allBoats[i].getOrigin() %></td>
                                    <td><%= allBoats[i].getCurrency() %></td>
                                    <td>
